...
//    private double MAXCNT = 5;
    ...
    private void Lr2gene_mainloop() {
        getOpt(seq2copt);
        Map<String, Map<String, List<Sample>>> g2amp = new HashMap<>();
        ...
        for (Sample sqr : inputGenes) {
            ...
            Map<String, List<Sample>> gq;
            List<Sample> sq2amparr;
        ...
        int j = 0;
        for (Map.Entry<String, Map<String, List<Sample>>> entry : g2amp.entrySet()) {
            String Sample = entry.getKey();
            Map<String, List<Sample>> gq = entry.getValue();
...
//        double maxmd = 1;
    ...
    private static String joinDouble(String delim, double[] doubles) {
    ...
    private double[] convertDoubles(List<Double> doubles) {
        ...
        int i = 0;
        for (Iterator<Double> iterator = doubles.iterator(); iterator.hasNext(); i++) {
